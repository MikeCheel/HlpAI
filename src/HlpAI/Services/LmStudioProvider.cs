...
public class LmStudioProvider : IAiProvider
{
    ...
    public LmStudioProvider(HttpClient httpClient, string baseUrl = "http://localhost:1234", string model = DEFAULT_MODEL, ILogger? logger = null)
    {
    ...
    // Main constructor
    public LmStudioProvider(string baseUrl = "http://localhost:1234", string model = DEFAULT_MODEL, ILogger? logger = null)
    {
